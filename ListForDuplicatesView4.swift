...
struct ListForDuplicatesView4: View {
                    ...
                    ForEach(0..<duplicatesArray[sectIndex].count,id: \.self) { dupIndex in
                        ...
                        Button(action: {
                            ...
                            HStack{
                                ...
                                Text("\(duplicatesArray[sectIndex].first?.givenName ?? "") \(duplicatesArray[sectIndex].first?.familyName ?? "")")
                                    .bold()
                                    .font(.title2)
                            }
                        })
